...
const NAV: NavItem[] = [
  ...
  { key: "social", label: "Social Accounts", href: "/business-center/social", icon: "share" },
...
export default function BusinessShell({
  ...
  /** Light work surface for owner-audit screens only. Sidebar stays dark. */
  tone?: "default" | "light";
}) {
  return (
    <div className="relative flex min-h-screen" style={{ background: "#0a0607" }}>
      ...
      <main className="relative min-w-0 flex-1">
        ...
        <div
          className="amber-safe px-5 pt-1.5 pb-4 sm:px-8"
          style={tone === "light" ? { background: "#fff", color: "#111", minHeight: "calc(100vh - 72px)" } : undefined}
        >
          {children}
        </div>
      </main>
