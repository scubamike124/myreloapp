...
const CARDS: { n: number; icon: IconKey; title: string; desc: string; badge?: string; href: string }[] = [
  ...
  { n: 3, icon: "palette", title: "Brand Kit", desc: "Store your logos, colors, fonts, and brand assets.", href: "/business-center/brand-kit" },
  { n: 4, icon: "folder", title: "Assets", desc: "Access and manage all your media and resources.", badge: "NEW", href: "/business-center/assets" },
  { n: 5, icon: "share", title: "Social", desc: "Connect and grow your social channels.", badge: "SOON", href: "/business-center/social" },
  { n: 6, icon: "rocket", title: "Publishing", desc: "Publish your content everywhere.", badge: "SOON", href: "/business-center/publishing" },
  { n: 7, icon: "calendar", title: "Scheduling", desc: "Schedule posts and never miss a beat.", badge: "SOON", href: "/business-center/scheduling" },
  { n: 8, icon: "chart", title: "Analytics", desc: "Track performance and grow faster.", badge: "SOON", href: "/business-center/analytics" },
  { n: 9, icon: "dollar", title: "Revenue", desc: "Monitor earnings and growth.", badge: "SOON", href: "/business-center/revenue" },
  { n: 10, icon: "brain", title: "Trend AI", desc: "Discover trending topics and ideas.", badge: "SOON", href: "/trends" },
  { n: 11, icon: "crown", title: "Hub Pro", desc: "Unlock all pro tools and advanced features.", badge: "SOON", href: "/business-center/pro" },
];
      ...
      <div className="mb-7 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
        {CARDS.map((c) => (
          ...
          >
            ...
            {c.badge && (
              <span className="absolute right-3 top-3 rounded-md px-1.5 py-0.5 text-[9px] font-bold uppercase" style={c.badge === "NEW" ? { color: "#fff", background: "linear-gradient(135deg,#ff3645,#c4101c)" } : { color: "#c98", background: "rgba(255,255,255,.05)", border: "1px solid rgba(255,255,255,.1)" }}>{c.badge}</span>
            )}
            <Tile icon={c.icon} />
