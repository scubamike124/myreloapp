...
export default async function ToolPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  // need to get out of.
  const studio =
    slug === "bedtime-storybook" ? <StoryBook /> : slug === "ai-story-maker" ? <StoryMaker /> : slug === "product-commercial" ? <ProductCommercial /> : slug === "story-memory-generator" ? <MemoryFilm /> : slug === "shorts-20" ? <ShortsPlanner /> : slug === "website-commercial" ? <WebsiteCommercial /> : slug === "ai-avatar-studio" ? <AiAvatarStudio /> : <ToolStudio tool={tool} />;
