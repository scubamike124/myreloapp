...
const SECTIONS: Section[] = [
  ...
  { id: "business", title: "Business Center", icon: "grid", items: ["Dashboard", "Video Library", "Brand Kit", "Assets", "Publish queue", "Content calendar", "Workspace analytics", "Team invites", "Notifications", "Storage Manager", "Workspace Settings"] },
  { id: "business-pro", title: "Business Center Pro", icon: "crown", items: ["Pro Dashboard", "Business Profile", "Live Pro Tools", "AI Assist", "Content Hub", "Social Account Manager", "Workspace Reports", "Brand Kit", "Assets", "Create Studio", "Publish queue", "Content calendar"] },
  ...
  { id: "analytics", title: "Workspace analytics", icon: "chart", items: ["Videos created", "Images made", "Generations by day", "Usage by tool", "Token balance", "Tokens spent", "Token credits", "Token refunds"] },
  { id: "social", title: "Social Account Manager", icon: "share", items: ["Connect existing TikTok", "Connect existing Instagram", "Connect existing YouTube", "Multiple accounts per provider", "Disconnect / revoke", "OAuth token storage", "Amber assign to accounts", "Owner approval mode", "Facebook (future)"] },
  { id: "publishing", title: "Publish & calendar", icon: "rocket", items: ["Publish queue", "Draft → Ready → Exported", "Caption prep", "Platform targets", "Content calendar", "Amber-placed items", "Approval workflow", "Account assignment", "Honest publish adapters"] },
