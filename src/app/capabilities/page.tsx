...
const SECTIONS: Section[] = [
  ...
  { id: "business", title: "Business Center", icon: "grid", items: ["Dashboard", "Video Library", "Brand Kit", "Assets", "Notifications", "Storage Manager", "Workspace Settings"] },
  { id: "business-pro", title: "Business Center Pro", icon: "crown", items: ["Pro Dashboard", "Business Profile", "Live Pro Tools", "AI Assist", "Content Hub", "Workspace Reports", "Brand Kit", "Assets", "Create Studio"] },
