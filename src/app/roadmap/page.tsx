...
const PHASES: Phase[] = [
  ...
  },
  {
    ...
    groups: [
      ...
      { name: "Social Features", items: ["Groups", "Friends", "Family Groups", "Work Groups", "Birthday Videos", "Greeting Cards", "Holiday Videos", "Notifications", "Response reminders"] },
      { name: "Creator Challenges", items: ["Weekly challenges", "Scorecards", "Leaderboards", "Seasons", "Championships"] },
