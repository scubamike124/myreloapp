...
export const KNOWN_KEYS: KnownKey[] = [
  ...
  },
  {
    ...
    kind: "public",
    purpose: "Stripe Checkout for token packs (/api/billing/checkout)",
  ...
  },
  {
    ...
    kind: "secret",
    purpose: "Verifying POST /api/billing/webhook signatures",
    pattern: /^whsec_/,
    group: "Payments",
  },
  {
    ...
    kind: "secret",
    purpose: "Password-reset and transactional email",
  ...
  },
  {
    ...
    kind: "public",
    purpose: "From header for Resend emails (must be a verified domain)",
    source: "https://resend.com/domains",
    group: "Email",
  },
  {
  ...
  {
    name: "SOCIAL_TOKEN_SECRET",
    label: "Social token encryption secret",
    kind: "secret",
    purpose: "Encrypts OAuth tokens for connected TikTok / Instagram / YouTube accounts",
    group: "Social OAuth",
  },
  {
    ...
    kind: "public",
    purpose: "OAuth for connecting existing TikTok accounts",
  ...
  },
  {
    ...
    label: "Meta app ID",
    kind: "public",
    purpose: "OAuth for existing Instagram accounts",
  ...
  },
  {
    ...
    kind: "public",
    purpose: "OAuth for connecting existing YouTube channels",
  ...
  },
  {
    ...
    kind: "public",
    purpose: "OAuth redirect base (e.g. https://www.myreelo.com)",
    group: "Social OAuth",
  },
  {
    name: "AMBER_ADMIN_EMAILS",
    label: "Amber admin tester emails",
    kind: "public",
    purpose: "Comma-separated user emails allowed to use Amber Autonomous Mode when the flag is ON (in addition to Super Admin)",
    group: "Social OAuth",
  },
  {
    name: "AMBER_AUTONOMOUS_ENABLED",
    label: "Amber Autonomous kill switch",
    kind: "public",
    purpose: "Set false/off to force Amber Autonomous OFF regardless of admin toggle; true forces ON",
    group: "Social OAuth",
  },
  {
